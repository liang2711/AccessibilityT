...
public class AppListTouchListener implements RecyclerView.OnItemTouchListener {
    private float downX;
    private float downY;
    private float tmpX;
    ...
    private AppNameAdapter.AppViewHoder currentHolder;
    @Override
    public boolean onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                currentHolder = (AppNameAdapter.AppViewHoder) rv.getChildViewHolder(currentChild);
                downX = e.getX();
                downY = e.getY();
                moving = false;
                break;
